                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-cyan text-center">
                                <a href="<?php echo site_url('c_pakan/index'); ?>">
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-success text-center">
                                <a href="<?php echo site_url('c_chikin/index'); ?>">
                                    <h1 class="font-light text-white"><i class="mdi mdi-linux"></i></h1>
                                </a>
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-info text-center">
                                <a href="<?php echo site_url('c_pakan/index'); ?>">
                                    <h1 class="font-light text-white"><i class="mdi mdi-basket-fill"></i></h1>
                                </a>
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-warning text-center">
                                <a href="<?php echo site_url('c_lhk/index'); ?>">
                    ...
                    <div class="col-md-6 col-lg-3 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-danger text-center">
                                <a href="<?php echo site_url('c_lhk/tampil_laporan'); ?>">
                                    <h1 class="font-light text-white"><i class="mdi mdi-book"></i></h1>
                                </a>
                                <h6 class="text-white">Laporan Harian Kandang</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
