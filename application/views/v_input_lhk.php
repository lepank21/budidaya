                    ...
                    <div class="card col-sm-12">
                        <form class="form-horizontal" action="<?php echo site_url('c_lhk/input_lhk') ?>" method="post" enctype="multipart/form-data">
                            <div class="card-body ">
                                ...
                                <div class="form-group row">
                                    <label for="fname" class="col-sm-3 text-end control-label col-form-label">Kandang</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="kandang">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="fname" class="col-sm-3 text-end control-label col-form-label">Lantai</label>
                                    <div class="col-sm-8">
                                        <input type="lantai" class="form-control" name="lantai">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="lname" class="col-sm-3 text-end control-label col-form-label"> Pakan 1</label>
                                    <div class="col-sm-4">
                                        <select class="select2 form-select shadow-none" style="width: 100%; height:36px;" name="jenis_pakan_1">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="jumlah_pakan_1" placeholder="Jumlah Pakan Pertama">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="lname" class="col-sm-3 text-end control-label col-form-label"> Pakan 2</label>
                                    <div class="col-sm-4">
                                        <select class="select2 form-select shadow-none" style="width: 100%; height:36px;" name="jenis_pakan_2">
                                            <option value="">Jenis Pakan Kedua</option>
                                            <?php foreach ($pakan as $p) { ?>
                                                <option><?php echo $p->jenis ?></option>
                                            <?php } ?>
                                        </select>
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="jumlah_pakan_2" placeholder="Jumlah Pakan Kedua">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="lname" class="col-sm-3 text-end control-label col-form-label"> Deplesi</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="mati" placeholder="Mati">
                                    </div>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="afkir" placeholder="Afkir">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="lname" class="col-sm-3 text-end control-label col-form-label"> Bobot</label>
                                    <div class="col-sm-8">
